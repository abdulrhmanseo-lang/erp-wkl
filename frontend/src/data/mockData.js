...
export const sidebarMenu = [
  ...
  { id: 'employees', label: 'إدارة الموظفين', icon: 'employees', path: '/app/employees' },
  { id: 'hr', label: 'الموارد البشرية', icon: 'hr', path: '/app/hr' },
  { id: 'clients', label: 'إدارة العملاء', icon: 'clients', path: '/app/clients' },
  { id: 'reports', label: 'التقارير', icon: 'reports', path: '/app/reports' },
